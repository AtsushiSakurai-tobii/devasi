...
colnames(attdata.df)<-c("TobiiNo","Sex","Age","Occupation","Address","UseFrequency","RecordingNo","UseDesign","UserStatus","subs")
...
colnames(mains_fix)[c(18,19)]<-c("%OfDuration","%OfCount")
